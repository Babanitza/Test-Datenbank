...
app.post("/api/bestellungen", async (req, res) => {
  const {
    ...
    artikel_3, logo_3, logo_platzierung_3, farbe_2, groesse_3, anzahl_3, einzelpreis_3, kosten_3,
    gesamtkosten, rechnung_verschickt, bezahlt_am, erledigt
  } = req.body;

  if (!vorname || !nachname || !klasse || !e_mail || !telefonnummer || !strasse || !ort || !artikel_1) {
